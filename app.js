...
function drawYfPoint(svg,x,y,as,c,muted=false,dash){const px=x(as.yKink),axisY=y(GRAPH.Pmin),stroke=c||'rgba(34,197,94,.9)'; if(dash){line(svg,px,axisY,px,axisY-20,stroke,1.4,dash);} line(svg,px,axisY,px,axisY-12,stroke,muted?2.1:2.6); point(svg,px,axisY,muted?3.8:4.6,stroke); text(svg,px,axisY+22,'Yf','middle',stroke,12.5,true); return {x:px,y:axisY+22,w:34,h:20};}
